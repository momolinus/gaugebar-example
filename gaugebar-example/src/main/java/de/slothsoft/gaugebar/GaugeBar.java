...
public class GaugeBar extends Control {
    ...
    public static final EventType<Event> EVENT_TYPE_CHANGE_VALUE = new EventType<Event>("GaugeBarChange");
    public static final EventType<Event> EVENT_TYPE_CHANGE_MAX_VALUE = new EventType<Event>("GaugeBarMaxValue");
